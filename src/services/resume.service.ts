...
/**
Generates a professional resume using DeepSeek based on structured user input.
The model is instructed to return STRICT JSON that maps directly to our `Resume` schema.
*/
